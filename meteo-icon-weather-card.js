...
class WeatherCard extends LitElement {
  ...
  static async getConfigElement() {
    await import("./meteo-icon-weather-card-editor.js");
    return document.createElement("meteo-icon-weather-card-editor");
  }
...
customElements.define("meteo-icon-weather-card", WeatherCard);
